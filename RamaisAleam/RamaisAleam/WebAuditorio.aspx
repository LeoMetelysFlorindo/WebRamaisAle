<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebAuditorio.aspx.vb" Inherits="RamaisAleam.WebAuditorio" %>
    ...
    <div style="text-align:left; margin-left:10px; ">
     ...
     <asp:Table ID="Table3" runat="server" Height="36px" Width="835px"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server" BackColor="#7AC0DA">  
                <asp:TableHeaderCell ForeColor="Green">AUDITÓRIO BERLAMINO LINS</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
     ...
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Sala VIP</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4508</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4508</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow1" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Sala de Som</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4464</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4464</asp:TableCell>  
            </asp:TableRow>
