<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Web7Andar.aspx.vb" Inherits="RamaisAleam.Web7Andar" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
  ...
  <p style="height: 19px">
        ...
        <asp:Button ID="Button4" runat="server" Text="1º ANDAR" style="height: 26px" /> 
    ...
    <div style="text-align:left; margin-left:10px; ">
     ...
     <asp:Table ID="Table3" runat="server" Height="36px" Width="835px" BackColor="#7AC0DA"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server" >  
                <asp:TableHeaderCell ForeColor="White">7º ANDAR</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
    
    <asp:Table ID="Table1" runat="server" Height="36px" Width="835px" BackColor="#7AC0DA"> 
            <asp:TableHeaderRow ID="TableHeaderRow1" runat="server" >  
              <asp:TableHeaderCell ForeColor="Green">DIRETORIA DE INFORMÁTICA</asp:TableHeaderCell>               
            </asp:TableHeaderRow> 
    </asp:Table>
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Diretoria de Informática</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4535</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4535</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow1" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Engenharia de Rede</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4603</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4603</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow2" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Suporte Técnico de Informática</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4341</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4341</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow3" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Rede</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4628</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4628</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow4" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Aplicativos</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4340</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4340</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow5" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Manutenção</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4342</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4342</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow7" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Infraestrutura de TI</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4353</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4353</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow6" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Restaurante</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4317</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4317</asp:TableCell>  
            </asp:TableRow> 
        </asp:Table>
 </div>
</asp:Content>
