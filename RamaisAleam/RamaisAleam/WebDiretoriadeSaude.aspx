<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebDiretoriadeSaude.aspx.vb" Inherits="RamaisAleam.WebDiretoriadeSaude" %>
    ...
    <div style="text-align:left; margin-left:10px; ">
        ...
        <asp:Button ID="Button17" runat="server" Text="QUADRA POLIESPORTIVA RADIALISTA JOSÉ CLAUDIO DE SOUZA" Width="422px"  />                           
         ...
         <asp:Table ID="Table3" runat="server" Height="36px" Width="835px"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server" BackColor="#7AC0DA">  
                <asp:TableHeaderCell ForeColor="Green">CENTRO DE SAÚDE DR. LUIZ CARLOS AVELINO</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
     ...
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Recepção Enfermagem</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4520</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4520</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow8" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Recepção Odontológica</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4515</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4515</asp:TableCell>  
            </asp:TableRow>
             <asp:TableRow ID="TableRow9" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Diretoria de Saúde</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4519</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4519</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow10" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Assessoria</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4522</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4522</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow3" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Atenção a Saúde</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4574</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4574</asp:TableCell>  
            </asp:TableRow>     
             <asp:TableRow ID="TableRow13" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Apoio Administrativo</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4574</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4574</asp:TableCell>  
            </asp:TableRow>                
            <asp:TableRow ID="TableRow2" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Enfermagem</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4572</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4572</asp:TableCell>  
            </asp:TableRow>             
            <asp:TableRow ID="TableRow5" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência Médica</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4591</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4591</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow4" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Psicologia</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4591</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4591</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow1" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Atendimento Oftalmologia/Fisioterapia</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4504</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4504</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow7" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência Odontologia</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4502</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4502</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow6" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Serviço Social Ativo</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4573</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4573</asp:TableCell>  
            </asp:TableRow>
        </asp:Table>
</asp:Content>
