<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebEscola.aspx.vb" Inherits="RamaisAleam.WebEscola" %>
  ...
  <p style="height: 19px">
    ...
    <asp:Table ID="Table3" runat="server" Height="36px" Width="835px" BackColor="#7AC0DA"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server">  
                <asp:TableHeaderCell ForeColor="Green">ESCOLA DO LEGISLATIVO SENADOR JOSÉ LINDOSO</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
     ...
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Diretoria da Escola do Legislativo</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4529</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4529</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow12" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Vice Diretoria Escola</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4327</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4327</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow13" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Assessoria da Diretoria da Escola</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4586</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4586</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow14" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Junta Médica Pericial</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4316</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4316</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow1" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Suporte Técnico Logístico</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4509</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4509</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow2" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Secretaria da Escola do Legislativo</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4540</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4540</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow3" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Secretaria da Escola da Diretoria do Legislativo</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4370</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4370</asp:TableCell>  
            </asp:TableRow>            
            <asp:TableRow ID="TableRow5" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Treinamento e Desenvolvimento</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4393/4558</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4393</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow6" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência Didática Pedagógica</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4304</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4304</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow7" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Educação Cidadã</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4523/4576/4577</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4523</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow8" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Coordenadoria de Cultura</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4539</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4539</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow9" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Biblioteca</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4360</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4360</asp:TableCell>  
            </asp:TableRow>
             <asp:TableRow ID="TableRow10" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Lanchonete</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4525</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4525</asp:TableCell>  
            </asp:TableRow>
