<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebCentroTecnico.aspx.vb" Inherits="RamaisAleam.WebCentroTecnico" %>
...
<div style="font-family: Verdana; font-size: 17px; color: blue" class="content-wrapper">    
    ...
    <div style="text-align:left; margin-left:20px; ">
           <div style="padding:3px 0 0 0; height: 36px;">
            ...
            <asp:Button ID="Button13" runat="server" Text="5º ANDAR"  Visible="true" style="height: 26px" />  
    ...
    <div style="text-align:left; margin-left:10px; ">
      ...
      <asp:Table ID="Table3" runat="server" Height="36px" Width="835px"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server" BackColor="#7AC0DA">  
                <asp:TableHeaderCell ForeColor="Green">CENTRO TÉCNICO DO PODER LEGISLATIVO UMBERTO CALDERARO FILHO</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
     ...
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                ...
                <asp:TableCell HorizontalAlign="Center">4524</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4524</asp:TableCell>  
            </asp:TableRow> 
            <asp:TableRow ID="TableRow4" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">SESMT</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4521</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4521</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow2" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">RPG</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4506</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4506</asp:TableCell>  
            </asp:TableRow>
            <asp:TableRow ID="TableRow1" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Fisioterapia</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4530</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4530</asp:TableCell>  
            </asp:TableRow>            
            <asp:TableRow ID="TableRow3" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Gerência de Serviço Social Inativos</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4359</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4359</asp:TableCell>  
            </asp:TableRow>            
             <asp:TableRow ID="TableRow5" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Auditório Senador João Bosco</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4496</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4496</asp:TableCell>  
            </asp:TableRow>
