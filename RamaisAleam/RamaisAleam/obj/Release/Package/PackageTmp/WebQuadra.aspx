<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WebQuadra.aspx.vb" Inherits="RamaisAleam.WebQuadra" %>
    ...
    <div style="text-align:left; margin-left:10px; ">
        ...
        <asp:Button ID="Button17" runat="server" Text="QUADRA POLIESPORTIVA RADIALISTA JOSÉ CLAUDIO DE SOUZA" Width="422px"  />                           
         ...
         <asp:Table ID="Table3" runat="server" Height="36px" Width="835px"> 
            <asp:TableHeaderRow ID="TableHeaderRow3" runat="server" BackColor="#7AC0DA">  
                <asp:TableHeaderCell ForeColor="Green">QUADRA POLIESPORTIVA RADIALISTA JOSUÉ CLAUDIO DE SOUZA</asp:TableHeaderCell>                              
            </asp:TableHeaderRow> 
    </asp:Table>
     ...
     <asp:Table ID="Table4" runat="server" Height="37px" Width="835px"> 
            ...
            <asp:TableRow ID="TableRow27" runat="server" ForeColor="Teal">                  
                <asp:TableCell Font-Bold="True" ForeColor="BlueViolet">Coordenadoria de Esporte</asp:TableCell>  
                <asp:TableCell HorizontalAlign="Center">4545</asp:TableCell>  
                 <asp:TableCell HorizontalAlign="Center">3183-4545</asp:TableCell>  
            </asp:TableRow>            
        </asp:Table>
</asp:Content>
